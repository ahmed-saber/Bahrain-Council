...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="reviewcontainer" id="maintable1">
        <div class="row">
            <div class="grid_24"><h2>للذهاب / الموافقة على الملف:</h2></div>
        </div>
        <div class="row">
            <div class="grid_24">
                            ...
                            <div class="topheader_cont">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="desc">
                                            النصوص <strong>المعدلة بعد الموافقة</strong> <span>(</span> <span
                                                id="spnModAfterApprove">
                                ...
                                <form id="Form1" runat="server">
                                    <div id="divSessionActionButtons">
                                        <div class="SessionActionButtonsCont">
                                            <div class="fl">
                                                <input type="button" runat="server" id="btnApproveSession"
                                                    class="btnApproveSession def_btn" value="موافقة" />
                                            </div>
                                            <div class="fl">
                                                <input type="button" runat="server" id="btnFinalApproveSession"
                                                    class="btnFinalApproveSession def_btn" value="تصديق" />
                                            </div>
                                            <div class="clear">
                                            </div>
                                        </div>
